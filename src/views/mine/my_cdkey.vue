<template>
  <div class="">
    ...
    <div>
      <div class="banner">
        <div class="number">当前库存{{stock || 0}}张</div>
      ...
      <div>
        <van-tabs @click="onClick" title-active-color='#333333' title-inactive-color='#878787' line-width='52px' color="#f4c89b"
          ...
          <van-tab title="未使用" :disabled="isDisable">
            <van-pull-refresh v-model="refreshing" @refresh="onRefresh">
              <van-list v-model="loading" :finished="finished" :finished-text="finishedText" @load="onLoad">
                <div class="code-list">
                  ...
                  <van-empty v-if="codeList.length==0" class="custom-image" image="__CDN__/assets/blue/img/code/zanwujilu.png"
                    description="暂无兑换码记录" />
                </div>
              </van-list>
            </van-pull-refresh>
          ...
          <van-tab title="已使用" :disabled="isDisable">
            <van-pull-refresh v-model="refreshing" @refresh="onRefresh">
              <van-list v-model="loading" :finished="finished" :finished-text="finishedText" @load="onLoad">
                <div class="code-list">
                  <div class="code-item" v-for="(item,index) in userList" :key="index">
                    <div class="left-code">
                  ...
                  <van-empty v-if="userList.length==0" class="custom-image" image="__CDN__/assets/blue/img/code/zanwu.png"
                    description="暂无兑换码使用记录" />
                </div>
              </van-list>
            </van-pull-refresh>
